...
<style>
  ...
  @media (prefers-color-scheme: dark) {
    .perf-table thead { background-color: #004d40; color: #e0e0e0; }
    .perf-table tr:nth-child(even) { background-color: #2d2d2d; }
    .perf-table tr { color: #e0e0e0; }
    .perf-table th, .perf-table td { border-color: #444; }
    .perf-table .highlight { background-color: #1b5e20; color: #a5d6a7; }
    .perf-table .separator { background-color: #333; color: #ccc; }
  }
</style>
