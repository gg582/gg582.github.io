...
index 252e462d6..e3f677aa9 100644
--- a/net/core/dev.c
+++ b/net/core/dev.c
...
@@ -11432,7 +11422,6 @@ int register_netdevice(struct net_device *dev)
...
index cecfe6b81..760941e55 100644
...
@@ -532,12 +526,6 @@ static void bbr_set_cwnd(struct sock *sk, const struct rate_sample *rs,
 	if (!acked)
...
@@ -791,6 +778,10 @@ static void bbr_update_bw(struct sock *sk, const struct rate_sample *rs)
...
@@ -799,40 +790,15 @@ static void bbr_update_bw(struct sock *sk, const struct rate_sample *rs)
...
index a28037f0a..000000000
Binary files a/scripts/tracepoint-update and /dev/null differ
```
